...
def usage():
    ...
    print "bhpnet.py -t 192.168.0.1 -p 5555 -l -e=\"car /etc/passwd\""
...
def main():
    ...
    # are we gong to listen or just send data from stdin
    if not listen and len(target) and port > 0:

        # read in buffer from the commandline
        # this will block, so sen CTRL-D if not sending input
        # to stdin
